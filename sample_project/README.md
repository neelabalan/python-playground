...
New migrations should be added to `sample_project/migrations/versions/`:
...
If u want to create a new file with tables u should import tables to `sample_project/migrations/env.py`

```
import sample_project.users.tables # import new files here
```
